...
signed main(void) {
    ...
    TestCases {
        ...
        vector<pair<ll, ll>> k = {
            make_pair(xk + a, yk + b), make_pair(xk - a, yk + b),
            make_pair(xk + a, yk - b), make_pair(xk - a, yk - b),
            make_pair(xk + b, yk + a), make_pair(xk - b, yk + a),
            make_pair(xk + b, yk - a), make_pair(xk - b, yk - a)};

        vector<pair<ll, ll>> q = {
            make_pair(xq + a, yq + b), make_pair(xq - a, yq + b),
            make_pair(xq + a, yq - b), make_pair(xq - a, yq - b),
            make_pair(xq + b, yq + a), make_pair(xq - b, yq + a),
            make_pair(xq + b, yq - a), make_pair(xq - b, yq - a)};
